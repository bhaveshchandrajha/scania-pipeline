...
public class Invoice {
    ...
    private Integer fvGreater0;
    
    @Column(name = "F:B>0", precision = 3, scale = 0)
    private Integer fbGreater0;
    ...
    public String getReBonitat() {
        return reBonitat;
    }
    
    public void setReBonitat(String reBonitat) {
        this.reBonitat = reBonitat;
    }
    ...
    public Integer getFvGreater0() {
        return fvGreater0;
    }
    
    public void setFvGreater0(Integer fvGreater0) {
        this.fvGreater0 = fvGreater0;
    }
    
    public Integer getFbGreater0() {
        return fbGreater0;
    }
    
    public void setFbGreater0(Integer fbGreater0) {
        this.fbGreater0 = fbGreater0;
    }
