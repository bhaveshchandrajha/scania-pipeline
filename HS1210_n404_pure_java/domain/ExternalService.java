...
public class ExternalService {
    ...
    private String identifierExternal;
    ...
    private String sdpsExternalServiceUuid;
    ...
    public String getIdentifierExternal() {
        return identifierExternal;
    }

    public void setIdentifierExternal(String identifierExternal) {
    ...
    public String getSdpsExternalServiceUuid() {
        return sdpsExternalServiceUuid;
    }

    public void setSdpsExternalServiceUuid(String sdpsExternalServiceUuid) {
        this.sdpsExternalServiceUuid = sdpsExternalServiceUuid;
    }
}